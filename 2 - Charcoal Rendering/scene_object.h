...
public:
	...
	GLuint tex_handle, normal_handle, noisemap_handle, tex_array_handle;
	bool normal_mapped = false;
	bool noise_mapped = false;
	...
	scene_object(char* mesh_name, char* tex_name, char* normal_map_file, char* noisemap_file, char* texture_array_files[]);
	...
	bool load_textures(char* file_names[], GLuint* tex, int layers);
};
